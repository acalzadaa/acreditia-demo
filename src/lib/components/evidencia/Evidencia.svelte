<script lang="ts">
	...
	interface Props {
		items: EvidenciaItem[];
		onClickEditar: (item: EvidenciaItem) => void;
		onKeydownEditar: (e: KeyboardEvent, item: EvidenciaItem) => void;
		onClickBorrar: (item: EvidenciaItem) => void;
		onKeydownBorrar: (e: KeyboardEvent, item: EvidenciaItem) => void;
		onClickRestaurar: (item: EvidenciaItem) => void;
		onKeydownRestaurar: (e: KeyboardEvent, item: EvidenciaItem) => void;
	}
...
tooltipLabel="Restaurar registro"
		...
		{:else}
			<EmptySection message="No hay elementos de evidencia"></EmptySection>
		{/if}
	</section>
</main>
