<script lang="ts">
	...
	interface Props {
		entidadLegalItems: EntidadLegalItem[];
		onClickEditar: (item: EntidadLegalItem) => void;
		onKeydownEditar: (e: KeyboardEvent, item: EntidadLegalItem) => void;
		onClickBorrar: (item: EntidadLegalItem) => void;
		onKeydownBorrar: (e: KeyboardEvent, item: EntidadLegalItem) => void;
		onClickRestaurar: (item: EntidadLegalItem) => void;
		onKeydownRestaurar: (e: KeyboardEvent, item: EntidadLegalItem) => void;
	}
		...
		{#if entidadLegalItems.length > 0}
			<table class="data-table text-body">
				...
				<tbody class="text-body">
					{#each entidadLegalItems as item (item.id)}
