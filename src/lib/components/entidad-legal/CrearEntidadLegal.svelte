<script lang="ts">
	...
	import { entidadLegalFormSchema, type EntidadLegalForm } from '$lib/schemas/entidadLegal.schema';
	import Icon from '../ui/Icon.svelte';

	interface Props {
		open: boolean;
		form: SuperValidated<EntidadLegalForm>;
		onClose: () => void;
	}
	...
	const { form, errors, enhance, message } = superForm(props.form, {
		resetForm: false,
		validators: zod4(entidadLegalFormSchema),
