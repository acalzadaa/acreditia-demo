<script lang="ts">
	...
	interface Props {
		items?: SeccionWithCapituloItem[] | null;
		onClickEditar: (item: SeccionWithCapituloItem) => void;
		onKeydownEditar: (e: KeyboardEvent, item: SeccionWithCapituloItem) => void;
		onClickBorrar: (item: SeccionWithCapituloItem) => void;
		onKeydownBorrar: (e: KeyboardEvent, item: SeccionWithCapituloItem) => void;
		onClickRestaurar: (item: SeccionWithCapituloItem) => void;
		onKeydownRestaurar: (e: KeyboardEvent, item: SeccionWithCapituloItem) => void;
	}
 ...
 *   content     → ~255 chars → flex (min: 14rem, max: auto)
