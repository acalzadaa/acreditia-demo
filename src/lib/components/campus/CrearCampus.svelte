<script lang="ts">
	...
	import { type CampusForm, campusFormSchema } from '$lib/schemas/campus.schema';
	import type { EntidadLegalRef } from '$lib/schemas/entidadLegal.schema';
	import type { RegionRef } from '$lib/schemas/region.schema';
	import type { InstitucionRef } from '$lib/schemas/institucion.schema';
	import Icon from '../ui/Icon.svelte';

	interface Props {
		open: boolean;
		form: SuperValidated<CampusForm>;
	...
	const { form, errors, enhance, message } = superForm(props.form, {
		resetForm: false,
		validators: zod4(campusFormSchema),
