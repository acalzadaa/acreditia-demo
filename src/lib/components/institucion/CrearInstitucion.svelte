<script lang="ts">
	...
	import { indicadorEstrategicoFormSchema } from '$lib/schemas/indicadorEstrategico.schema';
	import type { InstitucionForm } from '$lib/schemas/institucion.schema';
	...
	interface Props {
		open: boolean;
		form: SuperValidated<InstitucionForm>;
