<script lang="ts">
	...
	interface Props {
		...
		onKeydownBorrar: (e: KeyboardEvent, item: AreaResponsableWithRelationsItem) => void;
		onClickRestaurar: (item: AreaResponsableWithRelationsItem) => void;
		onKeydownRestaurar: (e: KeyboardEvent, item: AreaResponsableWithRelationsItem) => void;
	}
