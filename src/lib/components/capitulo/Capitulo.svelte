<script lang="ts">
	...
	interface Props {
		items?: CapituloWithModeloItem[] | null;
		onClickEditar: (item: CapituloWithModeloItem) => void;
		onKeydownEditar: (e: KeyboardEvent, item: CapituloWithModeloItem) => void;
		onClickBorrar: (item: CapituloWithModeloItem) => void;
		onKeydownBorrar: (e: KeyboardEvent, item: CapituloWithModeloItem) => void;
		onClickRestaurar: (item: CapituloWithModeloItem) => void;
		onKeydownRestaurar: (e: KeyboardEvent, item: CapituloWithModeloItem) => void;
	}
