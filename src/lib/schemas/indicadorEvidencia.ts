...
// ============================================
export const indicadorEvidenciaRefSchema = z.object({
	id: z.uuid(),
	code: z.string(),
	name: z.string()
});

export type IndicadorEvidenciaRef = z.infer<typeof indicadorEvidenciaRefSchema>;
...
export const indicadorEvidenciaFormSchema = z.object({
	id: z.uuid().optional(),
	code: z
		.string()
...
export type IndicadorEvidenciaFormSchema = z.infer<typeof indicadorEvidenciaFormSchema>;
...
export type IndicadorEvidenciaItem = z.infer<typeof indicadorEvidenciaItemSchema>;
